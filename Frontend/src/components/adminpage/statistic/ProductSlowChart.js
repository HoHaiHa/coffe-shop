...
import { FiBox, FiFilter, FiAlertTriangle, FiBarChart2, FiDownload } from "react-icons/fi";
...
// Gradient colors for danger levels
const COLORS = [
  ["#EF4444", "#DC2626"], // Red gradient - Extremely slow
  ["#F97316", "#EA580C"], // Orange gradient - Very slow
  ["#F59E0B", "#D97706"], // Amber gradient - Moderately slow
  ["#EAB308", "#CA8A04"], // Yellow gradient - Somewhat slow
  ["#84CC16", "#65A30D"], // Lime gradient - Slightly slow
];
      ...
      >
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center gap-2">
            <FiBarChart2 className="text-xl text-red-500" />
