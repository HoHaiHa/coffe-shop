...
const COLORS = [
  "#ff0000", // đỏ - cực kỳ nguy hiểm
  "#ff4500", // đỏ cam - nguy hiểm cao
  "#ff8c00", // cam đậm - nguy hiểm vừa
  "#ffa500", // cam - nguy hiểm trung bình
  "#ffd700", // vàng - nguy hiểm thấp
];
    ...
    ? [
        data.reduce((acc, item, index) => {
          acc["name"] = view === "overview" 
            ? "Biểu đồ thể hiện những sản phẩm bán chậm" 
